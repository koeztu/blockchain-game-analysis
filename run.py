...
def main():
    ...
    #NOTE: uncomment below to print conservative and longest chain strategies
    """
    ...
    for t in range(T+1):
        print(f"decision-relevant payoff for naive miner 2 when mining at block {t} is", round(B.getNaiveDecisionRelevantPayoff(m, t), 3))
