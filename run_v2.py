...
#NOTE: we can now say at which block each miner type should mine, given their strategy. however, we cannot say if that is also optimal. that's the hard part.
